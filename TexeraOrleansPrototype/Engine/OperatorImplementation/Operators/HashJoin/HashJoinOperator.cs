    ...
    public class HashJoinOperator : Operator
    {
        ...
        public override Pair<List<WorkerLayer>, List<LinkStrategy>> GenerateTopology()
        {
            ...
            (
                ...
                {
                    new ProcessorWorkerLayer("hash_join.main",Constants.DefaultNumGrainsInOneLayer*2,(i)=>new HashJoinProcessor(InnerTableIndex,OuterTableIndex,InnerTableID),null)
                },
