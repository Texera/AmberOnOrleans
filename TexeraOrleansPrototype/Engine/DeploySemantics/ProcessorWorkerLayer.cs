...
namespace Engine.DeploySemantics
{
    public class ProcessorWorkerLayer : WorkerLayer
    {
        ...
        private Func<int,ITupleProcessor> workerGen;
        public ProcessorWorkerLayer(string id, int numWorkers,Func<int,ITupleProcessor> workerGen, Dictionary<String,Object> deployArgs):base(id,deployArgs)
        {
